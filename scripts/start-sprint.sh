...
echo "  /sprint-build sequential   — Build ALL stories, no prompts, auto UAT setup"
echo "  /sprint-build parallel     — Build ALL stories in parallel, auto UAT setup"
echo "  /develop backend [story]   — Implement single story backend"
echo "  /develop frontend [story]  — Implement single story frontend"
echo "  /build-with-agent-team     — Parallel execution by role"
