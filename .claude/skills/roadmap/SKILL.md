...
## Context — Read PRD
!`head -100 docs/prd/prd.md 2>/dev/null || echo PRD not found. Run /enterprise-prd first.`

## Context — Read Product Vision
!`head -50 docs/ideation/product-vision.md 2>/dev/null || echo Product vision not found.`
